...
<div class="p-8">
	<h1 class="text-4xl font-bold text-gray-800 mb-6">Rencana Tugas (To Do)</h1>

	{#if data.tasks.length === 0}
		<div class="text-center py-16">
			<p class="text-gray-500 text-lg">✨ Luar biasa! Kotak masukmu bersih.</p>
			<p class="text-gray-400">Tidak ada rencana tugas untuk saat ini.</p>
		</div>
	{:else}
		<ul class="space-y-4">
			{#each data.tasks as task (task.id)}
				<li
					class="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-500 transition hover:shadow-lg"
				>
